...
export function KnowledgeLibrary({ rows, allRows, relations, selected, receipt, onChoose, onReview, onWithdraw, busy, loading, contextError, detailError, renderEvidence, evidenceName }: any) {
