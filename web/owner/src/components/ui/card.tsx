...
export function Card({className,...props}:React.HTMLAttributes<HTMLDivElement>){return <div data-slot="card" className={cn("rounded-xl border border-[var(--line)] bg-white text-[var(--ink)] shadow-[0_1px_2px_rgba(24,26,32,.04)]",className)} {...props}/>}
