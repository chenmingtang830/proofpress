...
const requirements = [
  ...
  [app.includes("proofpress-shoulders-film-20260910-1080p.mp4") && app.includes('<span className="eyebrow">Our mission</span>') && app.match(/Knowledge worth building on\./g)?.length === 1, "the mission label and brand line appear only with the film"],
