...
const requirements = [
  ...
  [app.includes("infra for AI research teams.") && app.includes("AI research labs") && app.includes("Post-training teams") && app.includes("Benchmark &amp; evaluation teams"), "the research audience and target team types are explicit"],
  ...
  [html.includes("Proofpress — Verified knowledge infra for AI research teams") && html.includes("Reuse trusted findings. Reduce repeated work."), "page and social text metadata use the current research positioning"],
];
