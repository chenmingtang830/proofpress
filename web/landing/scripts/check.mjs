...
const requirements = [
  ...
  [app.includes("Humans decide.") && app.includes("Only admitted claims move forward."), "human authority is explicit"],
  [app.includes("Higher performance. Errors stopped from spreading.") && app.includes("126 agent handoffs") && app.includes("Proofpress’s governed claims ledger") && app.includes("observed unsafe propagation") && app.includes("not an official Harvey benchmark"), "study result is plain-language while method and claim boundary remain explicit"],
