...
const requirements = [
  ...
  [app.includes('className="mobileNav"') && app.includes("View evidence and reuse scope") && app.includes("Human Approval") && app.includes("Evaluate outcomes") && app.includes("Refine knowledge") && !app.includes('className="loopReturn"'), "mobile disclosure and the separate learning-loop section preserve the complete research story without a redundant return strip"],
  ...
  [app.includes("Human Approval authorizes reuse") && app.includes("Use governed context") && app.includes("knowledge and claims that shaped them") && app.includes("Refine knowledge") && !app.includes("UPDATE TRUST WEIGHTS"), "the learning loop connects governed context, downstream claims, outcomes, and evidence-led refinement without implying automatic trust weighting"],
