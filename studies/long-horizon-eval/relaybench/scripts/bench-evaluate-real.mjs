...
const scores = {};
for (const condition of packet.conditions) scores[condition] = await evaluatePublicRubric({ taskPath: upstreamTask,
  deliverable: state.episodes[condition].deliverable, evaluator: manifest.evaluator });
