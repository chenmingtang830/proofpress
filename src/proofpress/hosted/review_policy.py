...
PROVIDERS = {
    "openrouter": {"label": "OpenRouter", "endpoint": "https://openrouter.ai/api/v1/chat/completions", "default_model": "deepseek/deepseek-v4-flash", "models": ["deepseek/deepseek-v4-flash", "openai/gpt-5.4", "anthropic/claude-sonnet-4.5", "google/gemini-3.8-flash"], "zdr": True},
    "openai": {"label": "OpenAI", "endpoint": "https://api.openai.com/v1/chat/completions", "default_model": "gpt-5.4", "models": ["gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano"], "zdr": False},
    ...
    "google_gemini": {"label": "Google Gemini", "endpoint": "https://generativelanguage.googleapis.com/v1beta/openai/chat/completions", "default_model": "gemini-3.8-flash", "models": ["gemini-3.8-pro", "gemini-3.8-flash", "gemini-3.5-flash"], "zdr": False},
    "xai": {"label": "xAI", "endpoint": "https://api.x.ai/v1/chat/completions", "default_model": "grok-4.6", "models": ["grok-4.6", "grok-4.1-fast"], "zdr": False},
    "groq": {"label": "Groq", "endpoint": "https://api.groq.com/openai/v1/chat/completions", "default_model": "openai/gpt-oss-20b", "models": ["openai/gpt-oss-120b", "openai/gpt-oss-20b", "llama-3.3-70b-versatile"], "zdr": False},
    "mistral": {"label": "Mistral AI", "endpoint": "https://api.mistral.ai/v1/chat/completions", "default_model": "mistral-large-latest", "models": ["mistral-large-latest", "mistral-medium-latest", "mistral-small-latest"], "zdr": False},
